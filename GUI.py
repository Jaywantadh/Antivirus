...
def execute_engine(file_path, output_text):
    if file_path:
        ...
        process = subprocess.Popen(["/home/jaywant/Desktop/Antivirus/engine", file_path], stdout=subprocess.PIPE, universal_newlines=True)
...
def execute_engine_rtm(file_path, output_text):
    if file_path:
        ...
        # Execute engine.exe and capture output
        file_label.config(text=file_path)
        process_rtm = subprocess.Popen(["/home/jaywant/Desktop/Antivirus/enginertm", file_path], stdout=subprocess.PIPE, universal_newlines=True)
...
def toggle_win():
    ...
    global menu_close
    tmp_pic = Image.open("/home/jaywant/Desktop/Antivirus/fileImage.png")
...
tmp_pic = Image.open("/home/jaywant/Desktop/Antivirus/menuButton.png")
resized_tmp_pic = tmp_pic.resize((50, 50), Image.LANCZOS)
...
upload_image = Image.open("/home/jaywant/Desktop/Antivirus/Upload.png")
